...
### pytorch
- Opened: [#175027](https://github.com/pytorch/pytorch/pull/175027) [pallas backend] tiling on tpu (@v0i0)
...
- Opened: [#34966](https://github.com/jax-ml/jax/pull/34966) [ROCm] Skip test_batch_axis_sharding_jvp (@AratiGanesh)
...
- Opened: [#34974](https://github.com/jax-ml/jax/pull/34974) [ROCm] Added ROCm tests to `device_test.py` unit test file. (@tsrw2048)
...
- Opened: [#34279](https://github.com/vllm-project/vllm/pull/34279) [Bugfix] Fix fused MoE IMA (sans chunking) by using int64 fo (@tlrmchlsmth)
...
- Opened: [#34192](https://github.com/vllm-project/vllm/pull/34192) [ROCm] Enable MXFP4 MoE weight pre-shuffling on gfx950 and u (@dllehr-amd)
...
- Opened: [#34280](https://github.com/vllm-project/vllm/pull/34280) [ROCm][CI] Fix test_sequence_parallel.py location in AMD CI  (@micah-wil)
...
- Merged: [#34153](https://github.com/vllm-project/vllm/pull/34153) [Bugfix][ROCm][GPT-OSS] Use old triton_kernels implementatio (@gshtras)
- Merged: [#34108](https://github.com/vllm-project/vllm/pull/34108) [ROCm][Bugfix] Resolve Dynamo tracing crash from amdsmi call (@AndreasKaratzas)
...
- Merged: [#30525](https://github.com/vllm-project/vllm/pull/30525) [Release 2.10] Update to Torch 2.10 - final release (@atalman)
...
- Opened: [#18528](https://github.com/sgl-project/sglang/pull/18528) Fp8 prefill attn kernel integration (@1am9trash)
...
- Merged: [#18320](https://github.com/sgl-project/sglang/pull/18320) [TBO] fix cuda graph intermittently becomes disabled bug (@billishyahao)
...
- Merged: [#18488](https://github.com/sgl-project/sglang/pull/18488) Tilelang sparse decode fwd for dsv32 mi355 (@1am9trash)
- Merged: [#18425](https://github.com/sgl-project/sglang/pull/18425) [AMD] Turn on aiter-prebuild (@yctseng0211)
