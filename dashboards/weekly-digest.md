...
- Opened: [#175893](https://github.com/pytorch/pytorch/pull/175893) [DTensor] Track per-output placements for multi-output ops i (@pianpwk)
...
- Merged: [#35008](https://github.com/vllm-project/vllm/pull/35008) [CI] Stabilizing ROCm amd-ci signal and minor name fix in up (@AndreasKaratzas)
...
- Opened: [#19592](https://github.com/sgl-project/sglang/pull/19592) [AMD] Fix tilelang NSA crash caused by unpinned tvm-ffi in C (@michaelzhang-ai)
...
### aiter
- Opened: [#2139](https://github.com/ROCm/aiter/pull/2139) [DRAFT]moe lqq test (@feifei14119)
...
### flydsl
- Opened: [#160](https://github.com/ROCm/FlyDSL/pull/160) Pr/v0.1 (@coderfeli)
- Opened: [#143](https://github.com/ROCm/FlyDSL/pull/143) W4a16 bf16 fp8 bf16 moe (@ClementLinCF)
- Opened: [#161](https://github.com/ROCm/FlyDSL/pull/161) [Pass][gpu-stream-inject] Add fly-gpu-stream-inject pass (@jli-melchior)
...
### pytorch
- [#176078](https://github.com/pytorch/pytorch/issues/176078) custom_op with mutable optional arguments (@ngc92)
- [#176077](https://github.com/pytorch/pytorch/issues/176077) `torch.vmap(torch.compile(jvp_fn, fullgraph=True))` fails wi (@tristancinquin)
- [#176076](https://github.com/pytorch/pytorch/issues/176076) A portion of shared parameter is not being update when shard (@f14-bertolotti)
- [#176074](https://github.com/pytorch/pytorch/issues/176074) DISABLED test_index_reduce_reduce_prod_mps_int32 (__main__.T (@malfet)
...
- [#35637](https://github.com/vllm-project/vllm/issues/35637) [Bug]: minimax m2.1 arch mxfp4 rocm AITER TP4 error (@functionstackx)
...
- [#35633](https://github.com/vllm-project/vllm/issues/35633) [Bug]: parity with cuda: rocm image missing amd quark kimi k (@functionstackx)
