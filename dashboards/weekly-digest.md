...
- Opened: [#35670](https://github.com/vllm-project/vllm/pull/35670) [Bug] Fix Failure in /v1/chat/completions/render for Multimo (@sergey-zinchenko)
...
- Opened: [#35677](https://github.com/vllm-project/vllm/pull/35677) [Bugfix] Fix ModelOpt Llama-4 slow checkpoint loading via te (@universeplayer)
...
### flydsl
- Opened: [#165](https://github.com/ROCm/FlyDSL/pull/165) Add fused GDR decode (@huizzhan)
- Opened: [#163](https://github.com/ROCm/FlyDSL/pull/163) Dev/yadai uint4 moe refactor (@yadaish)
...
- [#176112](https://github.com/pytorch/pytorch/issues/176112) DISABLED test_clear_saved_tensors_on_access (__main__.TestAu (@pytorch-bot[bot])
- [#176139](https://github.com/pytorch/pytorch/issues/176139) DISABLED test_cudagraph_memory_cleanup_benchmarker (__main__ (@etaf)
...
- [#35704](https://github.com/vllm-project/vllm/issues/35704) [Bug]: Cannot start the Qwen3.5-27B-FP8 model with error (@cyysky)
