...
- Opened: [#19416](https://github.com/sgl-project/sglang/pull/19416) [AMD] remove H2D op in atier attention backend (@AMD-yanfeiwang)
...
- Opened: [#38360](https://github.com/openxla/xla/pull/38360) [ROCm] Fix triton integration failures (@amd-jianli12)
...
- Merged: [#38019](https://github.com/openxla/xla/pull/38019) PR #38007: Gracefully handle missing handler on legacy custo (@copybara-service[bot])
- Merged: [#38023](https://github.com/openxla/xla/pull/38023) PR #36882: [ROCm] suppress cuda error messages on ROCm when  (@copybara-service[bot])
